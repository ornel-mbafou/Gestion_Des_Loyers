...
<div class="p-8 ml-40">
    ...
    <div class="bg-white rounded-xl shadow p-6 max-w-2xl">
        ...
        <form action="{{ route('logement.update', $logement->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" rows="4"
                    class="w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('description', $logement->description) }}</textarea>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('logement') }}" 
                    class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-3 rounded-lg transition font-medium text-center">
                    Annuler
                </a>
            </div>
