{{-- resources/views/components/locataire/topbar.blade.php --}}
...
<header class="fixed top-0 left-72 right-0 h-20 bg-white border-b shadow-sm z-40">
    ...
    <div class="h-full px-8 flex items-center justify-between">
        ...
        <div class="flex items-center gap-5">
            ...
            <!-- PROFILE -->
            <div class="flex items-center gap-3 bg-gray-100 px-4 py-2 rounded-2xl">

                <!-- IMAGE -->
                <img src="{{ asset('images/photo de profil/admin.jpg')}}"
                     alt="profil"
